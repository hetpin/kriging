...
from get_dif import getAStationTempNormalize
...
for x in xrange(1,size+1):
	list_station_all.append(getAStationTempNormalize(str(x)))
	#list_index.append(x)
...
plt.ylabel('r')
plt.savefig(os.path.splitext(os.path.basename('temp_correlation_all_normalize_by_alt'))[0] + '.png')
