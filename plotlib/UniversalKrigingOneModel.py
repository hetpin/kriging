...
def main_program():
	...
	exportGeotiff('t11_GEOTIFF_universal_kriging', result, row, col, shift, minLon, minLat )
	saveAsPng(result)
...
f.close()
#exportGeotiff('filename', raster, row, col, shift, minLon, minLat)
exportGeotiff('t8_GEOTIFF_universal_kriging', result, row, col, shift, minLon, minLat )
saveAsPng(result)
saveAsPng(derivation)
'''
#INTERPOLATE
