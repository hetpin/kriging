...
for line in fileinput.input(glob.glob("data_terra/*.xls")):
	search = 'RH.xls' #Tim tung thang cho nay//BT010111
	...
	worksheet_humid = workbook.sheet_by_name('Retrieved_Moisture_Profile')
...
#					print cell_value
					...
					if cell_type != 0:
						...
						list_.append((terra_date, terra_time,terra_station_id, terra_temp_13 -273.15, cell_value_water, terra_rain))
						index = index + 1
	for item in list_:
		print item
con = None
try:
    ...
    query = "INSERT INTO terra_3 (terra_date, terra_time,terra_station_id, terra_temp, terra_humid, terra_rain) VALUES (%s, %s, %s,%s,%s,%s)"
